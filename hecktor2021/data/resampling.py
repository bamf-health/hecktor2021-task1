...
from . import utils_resampling

# import (get_sitk_volume_from_np, get_np_volume_from_sitk)
...
def resample_and_crop(
    ...
    np_volume, pixel_spacing, origin = utils_resampling.get_np_volume_from_sitk(
    ...
    sitk_volume = utils_resampling.get_sitk_volume_from_np(
        np_volume, resampling, origin
    )
